...
class AuthService {
    public function __construct(private FolkRepository $folkRepository, private UserPasswordHasherInterface $passwordHasher, private JWTTokenManagerInterface $JWTTokenManager) {}
